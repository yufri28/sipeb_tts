...
document.addEventListener('DOMContentLoaded', function() {
 ...
 <!-- Modal Konfirmasi -->
 <div class="modal fade" id="masukStok" tabindex="-1" role="dialog" aria-hidden="true">
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             <form action="<?=base_url('barangmasuk/masuk_stok');?>" method="post">
                 <div class="modal-header border-0">
                     <h5 class="modal-title">
                         <span class="fw-mediumbold">Konfirmasi</span>
                         <span class="fw-light">Barang Masuk Stok</span>
                     </h5>
                     <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                         <span aria-hidden="true">&times;</span>
                     </button>
                 ...
                 <div class="modal-body">
                     <div class="row">
                         <div class="col-sm-12">
                             <p>
                                 Data tidak bisa diubah lagi jika barang masuk ke stok. Pastikan semua data sudah benar.
                                 <br>
                             <div class="text-center">
                                 <strong>Anda yakin ingin memasukan barang ke stok?</strong>
                             </div>
                             </p>
                         </div>
                     </div>
                 ...
                 <div class="modal-footer border-0">
                     <input type="hidden" name="stok_id" id="masuk_stok_id">
...
document.addEventListener('DOMContentLoaded', function() {
    // Ketika tombol hapus diklik
    var masukStok = document.getElementById('masukStok');
    masukStok.addEventListener('show.bs.modal', function(event) {
        var button = event.relatedTarget; // Tombol yang memicu modal
        var stokId = button.getAttribute('data-id'); // Ambil data masuk_stok_id
        var modalStokId = document.getElementById('masuk_stok_id');
        modalStokId.value = stokId; // Set hidden input dengan masuk_stok_id
    });
});
 </script>