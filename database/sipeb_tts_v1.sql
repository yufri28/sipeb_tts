...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Jul 2025 pada 04.00
...
(23, 1, 16, '02a0eeb1-de20-448e-8d08-f7f952196d20');
...
(16, 2, 'e0897740-2001-4e3a-861b-043e10447605', 6, 8),
...
(17, '2025-07-15', '2025-07-15', '2025-07-17', 'Aliando', '081287747170', '-', '-', '02a0eeb1-de20-448e-8d08-f7f952196d20', 'terima', 'selesai', 'Silahkan hubungi admin', 6, 'Aliando, S.Si', 'Staf Sekertariat', 'Drs. Yerry O. Nakamnanu, M.Si', 'Kepala BPBD', '929292929292');
...
--
ALTER TABLE `barang_keluar`
  MODIFY `id_barang_keluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT untuk tabel `barang_pinjam`
--
ALTER TABLE `barang_pinjam`
  MODIFY `id_barang_pinjam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `kondisi_terkini`
  MODIFY `id_kondisi_terkini` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
